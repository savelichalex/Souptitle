...
while (G__31980__i < G__31980__a.length) {G__31980__a[G__31980__i] = arguments[G__31980__i + 0]; ++G__31980__i;}
  args = new cljs.core.IndexedSeq(G__31980__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__31981){
...
return cljs.core.get_in.call(null,new_db,p1__31982_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__31983_SHARP_){
return cljs.core.get_in.call(null,db,p1__31983_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__31984__i = 0, G__31984__a = new Array(arguments.length -  2);
while (G__31984__i < G__31984__a.length) {G__31984__a[G__31984__i] = arguments[G__31984__i + 2]; ++G__31984__i;}
  in_paths = new cljs.core.IndexedSeq(G__31984__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__31985){
var f = cljs.core.first(arglist__31985);
arglist__31985 = cljs.core.next(arglist__31985);
var out_path = cljs.core.first(arglist__31985);
var in_paths = cljs.core.rest(arglist__31985);
